            ...
            <div class="col l-5 m-12 s-12 booking-form">
                ...
                <form action="<?= base_url() ?>finding" method="post">
                    ...
                    <div class="date">
                        ...
                        <label>
                            Ngày về<br /><input id="date-return" type="date" name="freturn" value="<?= date("Y-m-d") ?>"
...
<section id="partner">
    <div class="grid wide">
        ...
        <div class="row">
            ...
            <div class="col l-2">
                <a href="" class="item">
                    <img src="<?= base_url() ?>assets/images/Partner/koreanair.png" alt="koreanair" class="item-image">
                </a>
            </div>
            <div class="col l-2">
                <a href="" class="item">
