            ...
            <div class="col l-5 booking-form">
                ...
                <form action="<?= base_url() ?>finding" method="post">
                    ...
                    <div class="way">
                        <label>
                            Điểm đi<br />
                            <input class="choose" type="text" name="forigin" placeholder="Chọn" />
                        ...
                        <label>
                            Điểm đến<br />
                            <input class="choose" type="text" name="fdestination" placeholder="Chọn" />
                    ...
                    <div class="date">
                        <label>
                            Ngày đi<br /><input id="date-department" type="date" name="fdepartment" value=""
                                placeholder="Select date" />
                        </label>
                        <i class="fas fa-arrows-alt-h"></i>
                        <label>
                            Ngày về<br /><input id="date-return" type="date" name="freturn" value=""
                                placeholder="Select date" />
                        </label>
                    </div>
                ...
                $(document).on("click", "label:first-child .tab-container > li", function() {
                    ...
                    $(".list-city-wrap .list-city:nth-child(" + index + ")").addClass("list-active");
...
<section id="partner">
    <div class="grid wide">
        <div class="row">
            ...
            <div class="col l-2">
                <a href="" class="item">
                    <img src="<?= base_url() ?>assets/images/Partner/dntu.png" alt="Bamboo Airline" class="item-image">
                </a>
            </div>
