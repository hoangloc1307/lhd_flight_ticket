    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var i in data['news']) {
                ...
                text += '<a href="<?= base_url() ?>news/' + (data['news'][i]['LinkCustom'] != '' ?
                ...
                text += '</a>';
                text += '<p class="news-description">' + data['news'][i]['Description'] + '</p>';
                text += '<div class="date-view">';
                text += '<p class="news-date">';
                text += '<i class="far fa-calendar-alt"></i> ' + data['news'][i]['Date'] + '</p>';
                text += '<div class="news-view"><i class="far fa-eye"></i> ' + data['news'][i][
                    'View'
                ] + '</div>';
                ...
                if (data != "Không tìm thấy kết quả!") {
                    for (var i in data) {
                        ...
                        text += '<a href="<?= base_url() ?>news/' + (data[i][
                                'LinkCustom'
                            ] != '' ? data[i]['LinkCustom'] : data[i]['LinkDefault']) +
                        ...
                        text += '<div class="date-view">';
                        text += '<p class="news-date">';
                        text += '<i class="far fa-calendar-alt"></i> ' + data[i]['Date'] +
                            '</p>';
                        text += '<div class="news-view"><i class="far fa-eye"></i> ' + data[i][
                            'View'
                        ] + '</div>';
                        text += '</div></div></div></div>';
                    }
