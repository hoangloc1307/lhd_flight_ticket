        ...
        <nav class="menu-pc grid wide">
            ...
            <div class="links">
                <ul>
                    ...
                    <li><a href="#">Reference Informations</a></li>
                    <li><a href="#">Bonus</a></li>
                    <li class="user">
                        <a href="<?php if ($this->session->userdata("username") === NULL) {
                                        echo 'login';
                                    } else {
                                        echo 'login/logout';
                                    } ?>">
    ...
    <main>
        ...
        <main>
            ...
            <footer>
                                ...
                                <ul class="footer-list">
                                    <li class="footer-item">
                                        <a href="#"
                                            ...
                                            Nguyễn Khuyến, KP5, phường Trảng Dài, TP. Biên Hòa, Tỉnh Đồng Nai</a>
                                    </li>
                                    <li class="footer-item">
                                        <a href="#"
                                            title="Đường Trần Thị Trọng, KP10, Phường 15, Quận Tân Bình, TPHCM">Khu phố
                ...
                <div class="copyright">
                    <p><i class="far fa-copyright"></i> 2021 - Bản quyền của LHD.<br><span>Dự án website bán vé máy bay
