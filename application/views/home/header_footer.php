...
<head>
    ...
    <meta property="og:description" content="Vé máy bay giá rẻ. Mua vé máy bay giá rẻ hãy đến với LHD Flight Ticket." />
                ...
                <div class="row about-us">
                    ...
                    <div class="col l-3 m-6 s-12">
                        ...
                        <ul class="footer-list">
                            ...
                            <li class="footer-item">
                                <a href="<?= base_url('news/cham-soc-khach-hang') ?>" title="Chăm sóc khách hàng">Chăm
                                    sóc khách hàng</a>
                            </li>
                            <li class="footer-item">
                    ...
                    <div class="col l-3 m-6 s-12">
                        ...
                        <ul class="footer-list">
                            ...
                            <li class="footer-item">
                                <a href="<?= base_url('news/dieu-khoan-su-dung') ?>" title="Điều khoản sử dụng">Điều
                                    khoản sử dụng</a>
                            </li>
                            <li class="footer-item">
                                <a href="<?= base_url('news/chinh-sach-bao-mat') ?>" title="Chính sách bảo mật">Chính
                                    sách bảo mật</a>
                            </li>
                    ...
                    <div class="col l-3 m-6 s-12">
                        ...
                        <ul class="footer-list">
                            ...
                            <li class="footer-item">
                                <a href="<?= base_url('news/huong-dan-dat-ve') ?>" title="Hướng dẫn đạt vé">Hướng dẫn
                                    đạt vé</a>
                            </li>
                            <li class="footer-item">
                                <a href="<?= base_url('news/cau-hoi-thuong-gap') ?>" title="Câu hỏi thường gặp">Câu hỏi
                                    thường gặp</a>
                            </li>
                        </ul>
                    </div>
