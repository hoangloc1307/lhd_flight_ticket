							...
							<ul class="box-sort">
								...
								<li class="timedown">
									<label for="timedown" class="label-radio">
										<input type="radio" id="timedown" class="sort" name="sort"
											checked="checked" value="_timedown" />
										<span class="label-circle"> </span>
								...
								<li class="totaltime">
									<label for="totaltime" class="label-radio">
										<input type="radio" id="totaltime" class="sort" name="sort"
											checked="checked" value="_totaltime" />
										<span class="label-circle"> </span>
								...
								<li class="airline">
									<label for="airline" class="label-radio">
										<input type="radio" id="airline" class="sort" name="sort"
											checked="checked" value="_airline" />
										<span class="label-circle"> </span>
							...
							<ul class="box-view">
								<li class="personal">
									<label for="personal" class="label-radio">
										<input type="radio" id="personal" class="view" name="view"
											checked="checked" value="_personal" />
	...
	success: function(response) {
		...
		for (var i in response.data) {
			...
			if (departure_scheduled > nowtime) {
				...
				var price = Math.round((flight_time / 20) * (Math.round(Math.random() * 10) / 10 +
					0.5));
				...
				flight += "<span>" + GetNameByIATA(departure_iata) + " - " + departure_iata +
					"</span>";
				...
				flight += "<div class='flight-detail-item'>";
				flight +=
					"<p class='title-detail'><i class='fas fa-ticket-alt'></i>Chi tiết giá vé</p>";
				flight += "<div class='flight-detail-wrap'>";
