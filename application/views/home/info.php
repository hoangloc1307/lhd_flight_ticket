                        ...
                        <div class="col l-6 m-12 s-12">
                            <form class="info">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="input-edit" type="mail" name="email"
                ...
                <div class="view-order">
                    ...
                    <div class="order-item">
                        <ul class="order-body">
                            ...
                            <li class="order-total"><?= number_format($payment_info['total_price'], 0, ".", ".") ?>
                                <p>VND</p>
                            </li>
                        ...
                        <div class="order-detail">
                            ...
                            <div class="heading">
                                ...
                                <h4><?php echo $item['Status'] == 1 ? 'Đã thanh toán' : 'Chưa thanh toán'; ?></h4>
                            </div>
                            ...
                            <div class="order-passenger">
                                ...
                                <div class="passenger-detail">
                                    ...
                                    <div class="type-ticket">
                                        <p>Loại vé: </p>
                                        <p><?php echo $item['Type'] == 'oneway' ? 'Một chiều' : 'Khứ hồi'; ?></p>
                                    </div>
                            ...
                            <div class="order-total">
                                ...
                                <div class="total-detail">
                                    ...
                                    <div class="taxes-fess">
                                        <p>Thuế & phí: </p>
                                        <p><?= number_format(($payment_info['total_price'] - $baseprice), 0, ".", "."); ?>
                                        </p>
                                        <p>VND</p>
                                    </div>
                                    <div class="total-price">
                                        <p>Tổng: </p>
                                        <p><?= number_format($payment_info['total_price'], 0, ".", ".") ?></p>
                                        <p>VND</p>
                                    </div>
                                </div>
