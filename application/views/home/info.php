            ...
            <div class="col l-12 m-12 s-12">
                <div class="info-user">
                    ...
                    <div class="row info-edit">
                        <div class="col l-6 m-12 s-12">
                            <form class="info">
                                <div class="form-group">
                                    ...
                                    <input class="input-edit" type="text" name="name" value="<?= $user_info['Name'] ?>">
                                    <input type="hidden" name="name_old" value="<?= $user_info['Name'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for=""><i class="fas fa-map-marker-alt"></i>Địa chỉ</label>
                                    <input class="input-edit" type="text" name="address"
                                        value="<?= $user_info['Address'] ?>">
                                    <input type="hidden" name="address_old" value="<?= $user_info['Address'] ?>">
                                </div>
                                <div class="form-group">
                                    <label for=""><i class="fas fa-phone"></i>Số điện thoại</label>
                                    <input class="input-edit" type="number" name="phone"
                                        value="<?= $user_info['Phone'] ?>">
                                    <input type="hidden" name="phone_old" value="<?= $user_info['Phone'] ?>">
                                </div>
                                <div class="form-group">
                        ...
                        <button type="submit" class="button-submit change-info">Lưu</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="view-order">
                    ...
                    <div class="order-item">
                        <ul class="order-body">
                            ...
                            <li class="order-status" payment='<?php echo $item['Status'] == 1 ? 'true' : 'false' ?>'>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.change-info', function() {
        var name_new = $('input[name="name"]').val();
        var address_new = $('input[name="address"]').val();
        var phone_new = $('input[name="phone"]').val();
        var name_old = $('input[name="name_old"]').val();
        var address_old = $('input[name="address_old"]').val();
