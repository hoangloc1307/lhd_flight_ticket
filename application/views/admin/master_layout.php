		...
		<div class="link-list">
			<ul class="links top">
				...
				<li>
					...
					<ul class="sub-links">
						...
						<li>
							<a href="<?= base_url('admin/news/category') ?>"><i
									class="fas fa-caret-right"></i>Danh
								mục
								bài viết</a>
						</li>
				...
				<li>
					...
					<ul class="sub-links">
						<li>
							<a href="<?= base_url('admin/whychooseus') ?>"><i class="fas fa-caret-right"></i>Vì
								sao
								chọn chúng tôi</a>
						</li>
						<li>
						...
						<li>
							<a href="<?= base_url('admin/payment') ?>"><i class="fas fa-caret-right"></i>Phương
								thức thanh toán</a>
						</li>
					</ul>
				</li>
				...
				<li>
					<a href="<?= base_url('admin/statistic') ?>"><i class="far fa-chart-bar"></i></i>Thống kê</a>
				</li>
				<li>
					<a href="<?= base_url('admin/customer') ?>"><i class="fas fa-users"></i>Khách hàng</a>
				</li>
				<li>
					<a href="#" id="file-manage"><i class="fas fa-photo-video"></i>Quản lý file</a>
				</li>
				<li>
					<a href="https://auth-db165.hostinger.com/index.php" target="_blank"><i
							class="fas fa-database"></i>Truy cập
						Database</a>
				</li>
			</ul>
			<ul class="links bottom">
				<li>
					...
					<ul class="sub-links">
						<li>
							<a href="<?= base_url('login/logout') ?>"><i class="fas fa-caret-right"></i>Đăng
								xuất</a>
						</li>
					</ul>
				</li>
